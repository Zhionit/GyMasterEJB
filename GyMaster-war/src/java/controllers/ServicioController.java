...
public class ServicioController implements Serializable {
    ...
    @EJB
    private sessionBeans.ServicioFacade ejbFacade;
    ...
    public Servicio getSelected() {
        if (current == null) {
            ...
            current.setServicioPK(new entities.ServicioPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getServicioPK().setCliente(current.getCliente1().getId());
    ...
    public Servicio getServicio(entities.ServicioPK id) {
    ...
    public static class ServicioControllerConverter implements Converter {
        ...
        entities.ServicioPK getKey(String value) {
            entities.ServicioPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new entities.ServicioPK();
            key.setCliente(values[0]);
            key.setId(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(entities.ServicioPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Servicio) {
                ...
                return getStringKey(o.getServicioPK());
            } else {
